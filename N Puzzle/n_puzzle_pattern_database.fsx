// The first version of the Pattern Database with Fringe Search.

// Not as good as I thought it would be, well unless I sum and divide by four.
// This works worse than the Manhattan distance.
...
let mapping_function_hor_top = // I am aiming for the horizontal strip on the top with this one
    function
    | 0uy -> 1uy
    | 1uy -> 2uy
    | 2uy -> 3uy
...
let mapping_function_hor_midtop =
    function
    | 0uy -> 1uy
    | 4uy -> 2uy
    | 5uy -> 3uy
...
let mapping_function_hor_midbottom =
    function
    | 0uy -> 1uy
    | 8uy -> 2uy
    | 9uy -> 3uy
...
let mapping_function_hor_bottom =
    function
    | 0uy -> 1uy
    | 12uy -> 2uy
    | 13uy -> 3uy
...
let mapping_function_ver_left = // I am aiming for the vertical strip on the left with this one
    function
    | 0uy -> 1uy
    | 4uy -> 2uy
    | 8uy -> 3uy
...
let mapping_function_ver_midleft =
    function
    | 0uy -> 1uy
    | 1uy -> 2uy
    | 5uy -> 3uy
...
let mapping_function_ver_midright =
    function
    | 0uy -> 1uy
    | 2uy -> 2uy
    | 6uy -> 3uy
...
let mapping_function_ver_right =
    function
    | 0uy -> 1uy
    | 3uy -> 2uy
    | 7uy -> 3uy
...
let value_functions =
    [|
    mapping_function_hor_top
    mapping_function_hor_midtop
    mapping_function_hor_midbottom
    mapping_function_hor_bottom
    mapping_function_ver_left
    mapping_function_ver_midleft
    mapping_function_ver_midright
    mapping_function_ver_right
    |]
    |> Array.map (fun x -> x, get_value_function_for_pattern k x)
